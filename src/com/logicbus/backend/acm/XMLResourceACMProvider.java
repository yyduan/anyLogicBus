...
public class XMLResourceACMProvider extends XMLResourceSimpleModelProvider<AccessControlModel>{
	...
	protected Document loadResource(Properties props) {
		String xrcURI = props.GetValue("acm.master","java:///com/logicbus/backend/acm/acm.xml#com.logicbus.backend.acm.AccessControlModel");
		String xrcURI2 = props.GetValue("acm.secondary","java:///com/logicbus/backend/acm/acm.xml#com.logicbus.backend.acm.AccessControlModel");		
